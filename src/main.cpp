...
uint256 hashGenesisBlock("0xd1cc96fd9a71bad56f0b7471f99c7d3df5f4dc5c097d62a6aa11834ee595ab0d");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // PayPalCrypto: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "PayPalCrypto Signed Message:\n";
...
{
    // PayPalCrypto: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 3000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 525600); // PayPalCrypto: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 172800; // PayPalCrypto: 3.5 days
static const int64 nTargetSpacing = 60; // PayPalCrypto: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // PayPalCrypto: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // PayPalCrypto: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // PayPalCrypto: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa82e2106a16a2effc3ba7055dc0bd9061496c16807d66872ce4209a16182481a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Paypal is now digital";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 3000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("e1f9969ad2e41258cf25b998982d777831be0c51c69672a0f6b3ad6cad88c58460d5b486a7250c50ec4debc829aa3299e82462213fc7973e1d3bf73c7c9b4d015b") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1459432787;
        block.nBits    = 504365644;
        block.nNonce   = 2159087033;

        if (fTestNet)
        {
            block.nTime    = 1459432787;
            block.nNonce   = 722931536;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xfa700ec31ec91a70246c5e19a6c71e379a9bf87d8b387d4d9ea80002fbf9b8cb"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // PayPalCrypto: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PayPalCryptoMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PayPalCryptoMiner : ProcessBlock, block not accepted");
    }
